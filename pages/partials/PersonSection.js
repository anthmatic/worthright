  ...
  return (
    <div className="container py-20">
      <h2 className="text-5xl font-serif font-bold text-center mb-20">
        <span className="text-wgold ">What can I do</span> if I sell my policy?
      </h2>
      <div className="grid md:grid-cols-3 gap-24">
        <Person
          image="/people/sally.png"
          text={'<span class="text-wgreen">Sally</span> is 80 years old. She purchased her policy 11 years ago to cover estate taxes. With the tax law changes, her family no longer needs the death benefit to pay for estate taxes. We gave Sally an opportunity to create cash now and eliminate her ongoing premium of $79,495 per year.'}
        />
        <Person
