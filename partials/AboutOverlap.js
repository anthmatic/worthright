...
const AboutOverlap = () => {
  return (
    <div className="container pb-20 -mt-12 text-center max-w-3xl px-5">
      <Image src="/icons/pinecone.png" height={77} width={59} />
      <h2 className="text-5xl font-serif font-bold text-center mt-10 mb-6">
        About Worthright Finance
      </h2>
      <p className="text-xl mb-4">
        Worthright is on a mission to help families live and afford a wonderful
        life as they age. We're here to illuminate and advocate for options you
